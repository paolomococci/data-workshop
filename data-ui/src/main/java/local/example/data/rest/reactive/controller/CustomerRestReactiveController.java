...
package local.example.data.rest.reactive.controller;
...
import local.example.data.rest.repository.CustomerRestRepository;
import reactor.core.publisher.Flux;
import reactor.core.publisher.Mono;

@RepositoryRestController
@RequestMapping(path = "/rest/reactive/customers")
public class CustomerRestReactiveController {
	...
	public ResponseEntity<?> readByNickname(@PathVariable String nickname) 
			throws URISyntaxException {
		List<Customer> customers = customerRestRepository.findByNickname(nickname);
