...
@SpringBootTest
public class DesignerRepositoryMockMvcTests {

	private static String DESIGNER_TEST_STRING = 
			"{\"nickname\":\"someone\"}";
	...
	public void verifyExistence() 
		...
		mockMvc
			...
			.andExpect(jsonPath("$._links.designers").exists());
	}
	...
	public void createTest() 
		...
		mockMvc
			...
			.andExpect(header().string("Location", containsString("designers/")));
	}
